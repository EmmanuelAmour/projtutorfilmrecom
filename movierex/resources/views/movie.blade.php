                            ...
                            @auth
                                ...
                                @else
                                    ...
                                    <form method="POST" action="{{ route('user.like.movie', ['movieId' => $movie['id']]) }}"
                                        ...
                                        @csrf
                                        <button type="submit"
                                            class="flex items-center space-x-2 px-4 py-2 rounded-lg bg-red-500 hover:bg-red-600 
                    ...
                    <div class="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap text-gray-300">
                        ...
                        @foreach ($movie['genres'] as $genre)
                            <a href="{{ route('search.genre', ['genre' => $genre['name']]) }}"
                                class="p-2 bg-blue-800 rounded-lg hover:bg-blue-700 text-blue-100">{{ $genre['name'] }}</a>
                        @endforeach
                    </div>
                </div>
