...
@section('content')
            ...
            <div class="flex flex-wrap items-center gap-3">
                <div class="filter-dropdown" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                         ...
                         class="absolute right-0 mt-2 w-64 bg-dark-800 border border-dark-600 rounded-xl shadow-xl z-50">
                        <div class="p-4 space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Genre</label>
                                <select class="w-full bg-dark-700 border border-dark-600 rounded-lg px-3 py-2 text-white">
                            ...
                            <button class="w-full btn bg-primary-500 text-black hover:bg-primary-600">
                                Apply Filters
                            </button>
                        </div>
                    </div>
                ...
                <div class="sort-dropdown" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="p-2">
                            <a href="#" class="block px-3 py-2 text-sm text-gray-300 hover:bg-dark-700 rounded-lg transition-colors">
            ...
            <div class="empty-state text-center py-16 animate-fade-in">
                <div class="max-w-md mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        <a href="{{ route('home') }}" 
                           class="btn bg-primary-500 text-black hover:bg-primary-600">
    ...
    <div class="fixed bottom-6 right-6 z-50" x-data="{ open: false }">
        ...
        <button @click="open = !open" 
                class="fab-main bg-primary-500 hover:bg-primary-600 text-black">
